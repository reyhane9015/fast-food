...
function DashboardBests({
  itemSalesCount,
  cSalesCount,
  customerCount,
  cardInfo,
  itemSalesCountPercentage,
}) {
  return (
    <div className="max-w-6xl m-auto">
      <div className="max-w-6xl m-auto grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        ...
        >
          <h2 className="text-xl mb-2 text-gray-600 font-semibold dark:text-gray-300">
            Best Sellers
          </h2>
          <p className="text-gray-500 text-sm">
            Lorem Ipsom dolar sitapm is in transactions customers
          </p>
          ...
          <div className="absolute bottom-2 left-0 right-0 mx-auto w-fit text-center">
            <Link href="/" className="text-gray-500 text-xs hover:text-primary">
              Show More
            </Link>
          </div>
        </motion.div>
        ...
        <div>
          <motion.div
            ...
            className="relative bg-light-SBackground dark:bg-dark-SBackground rounded-lg p-8 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]"
          >
            <h2 className="text-xl mb-2 font-semibold text-gray-600 dark:text-gray-300">
              Best Customers
            </h2>
          ...
          >
            ...
            <p className="text-gray-500 text-sm">
              Lorem Ipsom dolar sitapm is in transactions
            </p>

            {Object.entries(cSalesCount)
              .slice(0, 4)
              .map(([country, count]) => (
                <div
                  key={country}
      ...
      <div className="max-w-6xl m-auto w-full grid grid-cols-1 md:grid-cols-[0.7fr_0.3fr] gap-4 py-8">
        ...
        >
          <h2 className="text-xl mb-2 text-gray-600 font-semibold dark:text-gray-300 px-4">
            Transactions
          </h2>
            ...
            <table className="min-w-full leading-normal mt-4">
              ...
              <tbody>
                {cardInfo.slice(0, 10).map((info, index) => (
                  ...
                  >
                    <td className="text-green-800 bg-green-200 rounded-md p-2 text-[12px]">
                      Completed
                    </td>
        ...
        >
          <h2 className="text-xl text-gray-600 font-semibold dark:text-gray-300 p-8">
            Products Ratings
          </h2>
          ...
          <div className="h-[630px] overflow-y-hidden">
            {itemSalesCountPercentage
              .slice(0, 7)
              .map(([itemName, salesCount]) => (
                <div key={itemName} className="ratings-grid gap-2 my-4 px-4">
                  <div className="text-gray-600 dark:text-gray-300 pt-4 text-sm font-semibold">
                    {itemName}
                  </div>
                  <div>
                    <ProgressBar
