  ...
  return (
    <div className="max-w-xl m-auto border rounded-md p-4">
        <form className="grow" onSubmit={(e) => 
            onSubmit(e , {
                name,description ,basePrice ,sizes ,extraItems ,category ,ratings ,freeShipping}
            )}
        >
...
{/* 
            ...
            <div className="flex gap-2 items-center justify-between">
                ...
                <div>
                    <label className="p-2 inline-flex items-center gap-2 mb-2" htmlFor="FreeShipping">
                    <input
                        id="FreeShipping" type="checkbox" className="" value={'1'}
            ...
            <MenuItemPriceProps props={extraItems} setProps={setextraItems} label={'Item'}/>

            <button type="submit" className="mt-8" disabled={isSaving}>Save</button>
