...
function AddressInputs({addressProps , setAddressProps , isSaving , validatePhone , validatePostalCode , isEditable}) {

    const { phone , streetAddress , postalCode , country , countriesWithCities , city , cityOptions } = addressProps;
