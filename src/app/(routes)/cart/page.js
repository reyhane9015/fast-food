                  ...
                  <table className="min-w-full leading-normal">
                    <thead>
                      <tr>
                        ...
                        <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 dark:bg-dark-SBackground text-left text-md font-semibold text-light-text dark:text-dark-text uppercase tracking-wider"></th>
                      </tr>
                    </thead>
                      ...
                      {cartProducts?.length > 0 &&
                        cartProducts.map((product, index) => {
                          ...
                          return (
                            <tr
                              key={productKey}
                              className="hover:bg-gray-200 hover:cursor-pointer border-dashed border-b-2 border-b-gray-300 dark:hover:bg-dark-background"
                            >
                              <td className="font-semibold text-center text-light-text dark:text-dark-text">
                                {index + 1}
                              </td>
                              ...
                              <td className="font-semibold text-light-text dark:text-dark-text text-center">
                                {product.name}
                              </td>
                              ...
                              <td className="py-5 text-center">
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    toast.success(
                                      `${cartProducts[index].name} removed from the cart`
                                    );
                                  }}
                                >
                                  <Delete />
