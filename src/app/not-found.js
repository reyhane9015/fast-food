  ...
  return (
    <>
      ...
      <section className="bg-light-background dark:bg-dark-background min-h-screen pb-8 px-8 md:px-12">
        ...
        <div 
          className="relative z-40 text-center font-semibold h-screen flex flex-col gap-2 justify-center items-center">
            <h2 className="text-primary text-2xl">Page Not Found</h2>
            <Link href="/" className="text-gray-500 underline">Return Home</Link>
        </div>
