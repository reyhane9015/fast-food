...
function CategoriesPage() {
  ...
  async function handleCategorySubmit(e) {
    ...
    await toast.promise(creationPromise, {
      loading: editedCatergory
        ? "Updating Category..."
        : "Creating new category...",
      success: editedCatergory
        ? "Updated Category Successfully!"
        : "New category created successfully!",
      error: editedCatergory
        ...
        <div className="max-w-2xl m-auto border rounded-md p-4">
          <form className="grow" onSubmit={handleCategorySubmit}>
            <div className="flex gap-2 items-center">
              <div className="grow">
                <label>
                  {editedCatergory ? "Update category:" : "New Category Name"}
                </label>
                {editedCatergory && (
                  <>
              ...
              <div className="mt-2">
                <button
                  className="px-2 py-1 text-gray-600 font-semibold text-primary border-2 border-primary rounded-md"
                  type="button"
                  onClick={() => {
                    setEditedCategory(null);
                    setCategoryName("");
