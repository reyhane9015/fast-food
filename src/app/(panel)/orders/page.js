                        ...
                        <tbody>
                          {currentItems.map((order, index) => (
                            ...
                            >
                              ...
                              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm dark:bg-dark-SBackground">
                                <p className="text-light-text dark:text-dark-text whitespace-no-wrap text-lg font-bold text-primary">
                                  {order.totalPrice}$
                                </p>
                              </td>
                              ...
                              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm dark:bg-dark-SBackground">
                                <span className="relative inline-block px-3 py-1 font-semibold leading-tight">
                                  <span
                                    ...
                                    className={
                                      order.paid
                                        ? "absolute inset-0 opacity-50 rounded-full bg-green-200"
                                        : "absolute inset-0 opacity-50 rounded-full bg-red-200"
                                    }
                                  ></span>
                                  <span
                                    className={
                                      order.paid
                                        ? "relative text-green-800"
                                        : "relative text-red-800"
                                    }
                                  >
                                    {order.paid ? "Success" : "Faild"}
                                  </span>
                                </span>
                              </td>
